...
import { requestMembership, getMemberships, getMyMembership, approveMembership, rejectMembership, leaveMembership } from '../controllers/GroupMembershipController.js'
...
router.get('/:id_group/my-membership', auth, getMyMembership)
